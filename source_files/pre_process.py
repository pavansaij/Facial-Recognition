...
class preprocesses:
    def __init__(self, input_datadir, output_datadir,base_path):
        self.input_datadir = input_datadir
        self.output_datadir = output_datadir
        self.base_path = base_path

    def collect_data(self):
        print("md",self.base_path)
        ...
        with tf.Graph().as_default():
            ...
            with sess.as_default():
                ...
                pnet, rnet, onet = detect_face.create_mtcnn(sess, self.base_path+'\\npy')
...
def get_path_for_classifier():
    ...
    return base_path+"/pre_processed",base_path+"/test_images",base_path

output_datadir,input_datadir,base_path = get_path_for_classifier()
obj=preprocesses(input_datadir,output_datadir,base_path)
